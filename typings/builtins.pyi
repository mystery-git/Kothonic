...
class int:
    ...
    def to_float_or_null(self) -> Union[float, None]:
...
class float:
    ...
    def to_int_or_null(self) -> Union[int, None]:
...
class complex:
    ...
    @overload
    def __new__(cls, real: complex | SupportsComplex | SupportsFloat | SupportsIndex=0, imag: complex | SupportsFloat | SupportsIndex=0) -> Self:
        ...
...
class str(Sequence[str]):
    ...
    def starts_with(self, match: Union[str, tuple[str]]) -> bool:
        """Returns true if this string starts with the specified prefix."""
        ...

    def ends_with(self, match: Union[str, tuple[str]]) -> bool:
    ...
    def take_last(self, chars: int) -> str:
        """Returns a string containing the last n characters."""
        ...

    def drop(self, chars: int) -> str:
        """Returns a string with the first n characters removed."""
        ...

    def drop_last(self, chars: int) -> str:
        """Returns a string with the last n characters removed."""
        ...

    def index_of(self, match: str) -> int:
...
class function:
    ...
    if sys.version_info >= (3, 13):
        ...
        def __new__(cls, code: CodeType, globals: dict[str, Any], name: str | None=None, argdefs: tuple[object, ...] | None=None, closure: tuple[CellType, ...] | None=None, kwdefaults: dict[str, object] | None=None) -> Self:
            ...
    else:

        def __new__(cls, code: CodeType, globals: dict[str, Any], name: str | None=None, argdefs: tuple[object, ...] | None=None, closure: tuple[CellType, ...] | None=None) -> Self:
            ...
...
class list(MutableSequence[_T]):
    ...
    def filter_(self, predicate: Callable[[Any], bool]) -> list:
        """Returns a list containing only elements matching the given predicate."""
        ...

    def map_(self, transformation: Callable[[Any], Any]) -> list:
        """Returns a list containing the results of applying the given transform function to each element in the original collection."""
        ...

    def all_(self, predicate: Callable[[Any], bool]) -> bool:
        """Returns true if all elements match the given predicate."""
        ...

    def any_(self, predicate: Callable[[Any], bool]) -> bool:
        """Returns true if at least one element matches the given predicate."""
        ...

    def associate(self, transform: Callable[[Any], tuple[Any, Any]]) -> dict[Any, Any]:
    ...
    def contains(self, match: Any) -> bool:
        """Returns true if the element is found in the collection."""
        ...

    def contains_all(self, match: Collection[Any]) -> bool:
    ...
    def drop(self, items: int) -> _List[Any]:
        """Returns a list containing all elements except first n elements."""
        ...

    def drop_last(self, items: int) -> _List[Any]:
    ...
    def element_at_or_null(self, index: int) -> Union[Any, None]:
        """Returns an element at the given index or null if the index is out of bounds of this collection."""
        ...

    def element_at_or_else(self, index: int, defaultValue: Callable[[int], Any]) -> Any:
    ...
    def plus(self, other: Collection[Any]) -> _List[Any]:
...
class set(MutableSet[_T]):
    ...
    def plus(self, other: Any) -> _List[Any]:
        """Returns a list containing all elements of the original collection and then all elements of the given elements."""
        ...
...
@overload
def compile(source: str | ReadableBuffer | _ast.Module | _ast.Expression | _ast.Interactive, filename: str | bytes | PathLike[Any], mode: str, flags: Literal[0], dont_inherit: bool=False, optimize: int=-1, *, _feature_version: int=-1) -> CodeType:
    ...

@overload
def compile(source: str | ReadableBuffer | _ast.Module | _ast.Expression | _ast.Interactive, filename: str | bytes | PathLike[Any], mode: str, *, dont_inherit: bool=False, optimize: int=-1, _feature_version: int=-1) -> CodeType:
    ...

@overload
def compile(source: str | ReadableBuffer | _ast.Module | _ast.Expression | _ast.Interactive, filename: str | bytes | PathLike[Any], mode: str, flags: Literal[1024], dont_inherit: bool=False, optimize: int=-1, *, _feature_version: int=-1) -> _ast.AST:
    ...

@overload
def compile(source: str | ReadableBuffer | _ast.Module | _ast.Expression | _ast.Interactive, filename: str | bytes | PathLike[Any], mode: str, flags: int, dont_inherit: bool=False, optimize: int=-1, *, _feature_version: int=-1) -> Any:
    ...
...
if sys.version_info >= (3, 13):
    ...
    def eval(source: str | ReadableBuffer | CodeType, /, globals: dict[str, Any] | None=None, locals: Mapping[str, object] | None=None) -> Any:
        ...
else:
...
if sys.version_info >= (3, 13):
    ...
    def exec(source: str | ReadableBuffer | CodeType, /, globals: dict[str, Any] | None=None, locals: Mapping[str, object] | None=None, *, closure: tuple[CellType, ...] | None=None) -> None:
        ...
    ...
    def exec(source: str | ReadableBuffer | CodeType, globals: dict[str, Any] | None=None, locals: Mapping[str, object] | None=None, /) -> None:
        ...
...
class map(Generic[_S]):
    if sys.version_info >= (3, 14):
        ...
        @overload
        def __new__(cls, func: Callable[[_T1, _T2], _S], iterable: Iterable[_T1], iter2: Iterable[_T2], /, *, strict: bool=False) -> Self:
            ...

        @overload
        def __new__(cls, func: Callable[[_T1, _T2, _T3], _S], iterable: Iterable[_T1], iter2: Iterable[_T2], iter3: Iterable[_T3], /, *, strict: bool=False) -> Self:
            ...

        @overload
        def __new__(cls, func: Callable[[_T1, _T2, _T3, _T4], _S], iterable: Iterable[_T1], iter2: Iterable[_T2], iter3: Iterable[_T3], iter4: Iterable[_T4], /, *, strict: bool=False) -> Self:
            ...

        @overload
        def __new__(cls, func: Callable[[_T1, _T2, _T3, _T4, _T5], _S], iterable: Iterable[_T1], iter2: Iterable[_T2], iter3: Iterable[_T3], iter4: Iterable[_T4], iter5: Iterable[_T5], /, *, strict: bool=False) -> Self:
            ...

        @overload
        def __new__(cls, func: Callable[..., _S], iterable: Iterable[Any], iter2: Iterable[Any], iter3: Iterable[Any], iter4: Iterable[Any], iter5: Iterable[Any], iter6: Iterable[Any], /, *iterables: Iterable[Any], strict: bool=False) -> Self:
            ...
    else:
        ...
        @overload
        def __new__(cls, func: Callable[[_T1, _T2, _T3, _T4], _S], iterable: Iterable[_T1], iter2: Iterable[_T2], iter3: Iterable[_T3], iter4: Iterable[_T4], /) -> Self:
            ...

        @overload
        def __new__(cls, func: Callable[[_T1, _T2, _T3, _T4, _T5], _S], iterable: Iterable[_T1], iter2: Iterable[_T2], iter3: Iterable[_T3], iter4: Iterable[_T4], iter5: Iterable[_T5], /) -> Self:
            ...

        @overload
        def __new__(cls, func: Callable[..., _S], iterable: Iterable[Any], iter2: Iterable[Any], iter3: Iterable[Any], iter4: Iterable[Any], iter5: Iterable[Any], iter6: Iterable[Any], /, *iterables: Iterable[Any]) -> Self:
            ...
...
@overload
def open(file: FileDescriptorOrPath, mode: OpenTextMode='r', buffering: int=-1, encoding: str | None=None, errors: str | None=None, newline: str | None=None, closefd: bool=True, opener: _Opener | None=None) -> TextIOWrapper:
    ...

@overload
def open(file: FileDescriptorOrPath, mode: OpenBinaryMode, buffering: Literal[0], encoding: None=None, errors: None=None, newline: None=None, closefd: bool=True, opener: _Opener | None=None) -> FileIO:
    ...

@overload
def open(file: FileDescriptorOrPath, mode: OpenBinaryModeUpdating, buffering: Literal[-1, 1]=-1, encoding: None=None, errors: None=None, newline: None=None, closefd: bool=True, opener: _Opener | None=None) -> BufferedRandom:
    ...

@overload
def open(file: FileDescriptorOrPath, mode: OpenBinaryModeWriting, buffering: Literal[-1, 1]=-1, encoding: None=None, errors: None=None, newline: None=None, closefd: bool=True, opener: _Opener | None=None) -> BufferedWriter:
    ...

@overload
def open(file: FileDescriptorOrPath, mode: OpenBinaryModeReading, buffering: Literal[-1, 1]=-1, encoding: None=None, errors: None=None, newline: None=None, closefd: bool=True, opener: _Opener | None=None) -> BufferedReader:
    ...

@overload
def open(file: FileDescriptorOrPath, mode: OpenBinaryMode, buffering: int=-1, encoding: None=None, errors: None=None, newline: None=None, closefd: bool=True, opener: _Opener | None=None) -> BinaryIO:
    ...

@overload
def open(file: FileDescriptorOrPath, mode: str, buffering: int=-1, encoding: str | None=None, errors: str | None=None, newline: str | None=None, closefd: bool=True, opener: _Opener | None=None) -> IO[Any]:
    ...
...
def __import__(name: str, globals: Mapping[str, object] | None=None, locals: Mapping[str, object] | None=None, fromlist: Sequence[str] | None=(), level: int=0) -> types.ModuleType:
    ...
