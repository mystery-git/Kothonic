...
class kt_list(builtins.list):
    def flatten(self) -> builtins.list:
        """Flattens a list of nested lists into a single list."""
        ...

    def filter_(self, predicate: Callable[[Any], bool]) -> builtins.list:
        """Returns a list containing only elements matching the given predicate."""
        ...

    def map_(self, transformation: Callable[[Any], Any]) -> builtins.list:
...
def list_of(items: list) -> kt_list: ...
